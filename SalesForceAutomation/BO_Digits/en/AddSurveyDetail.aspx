<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddSurveyDetail.aspx.cs" Inherits="SalesForceAutomation.BO_Digits.en.AddSurveyDetail"  enableEventValidation="false"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadNumericTextBox ID="txtorder" runat="server" CssClass="form-control" Width="100%" NumberFormat-AllowRounding="false" DecimalDigits="0"  OnTextChanged="txtorder_TextChanged" AutoPostBack="true" RenderMode="Lightweight" ></telerik:RadNumericTextBox>
    ...
    ForeColor="Red">
                                  ...
                                  <asp:Label ID="lblorderDupli" runat="server" Visible="false" ForeColor="Red"></asp:Label>
    ...
    <div class="modal fade" id="kt_modal_1_8" tabindex="-1" role="dialog" style="height:auto" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Question has been deleted successfully.</span>
                </div>
                <div class="modal-footer">
