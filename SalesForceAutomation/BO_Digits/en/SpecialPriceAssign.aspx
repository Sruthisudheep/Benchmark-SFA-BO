                        ...
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="kt-portlet">
                                    ...
                                    <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                        <div class="col-lg-10">
                                            <h3 class="kt-portlet__head-title">All Customer
                                            </h3>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="kt-portlet">
                                    <div class="col-lg-12 row" style="padding-top: 20px; padding-bottom: 20px;">
                                        <div class="col-lg-10">
                                            <h3 class="kt-portlet__head-title">Assigned Customers With Route
                                            </h3>
                                        </div>
                                        <div class="col-lg-2">
    ...
    <div class="modal fade" id="kt_modal_1_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Special price already assigned for the customer for same period .</span>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="kt_modal_1_10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Please select atleast one Payment mode .</p>
                </div>
                <div class="modal-footer">
