            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (Id.Equals("") || Id == "0")                                //To check whether there is a value for ResponseID or not. For adding there won't be a value.
                    {
                        ...
                        {
                            if ((items.Value == "OP") || (items.Value == "HC"))
                            {
                                items.Checked = true;
                            }
                        }
        ...
        public void SaveData()
        {
            ...
            if (ResponseID.Equals("0") || ResponseID == 0)
            {
                ...
                string[] arr = {   cus,cusType,TCL , CDays,PT,
                    ...
                    CusLocation,RecentSales,RecentOrder,MinOrderValue,ARRemarks,GRSettings,BrSettings,VoidEnableCusInsight,EnableDelPriceChange,ARPayMode,rcs_EnforceBuyBackFree};
