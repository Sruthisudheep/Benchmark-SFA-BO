...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class OutstandingManage : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            string Customer = rdCustomer.SelectedValue.ToString();
            ViewState["cus"] = Customer;
        ...
        public void AssignRoute()
        {
            ...
            try
            {
                if (ViewState["cus"].ToString() != null)
                {
                    int CusId;
                    if (int.TryParse(ViewState["cus"].ToString(), out CusId))
                    {
                        ddlRoute.DataSource = ObjclsFrms.loadList("SelectRouteForOutstangingInv", "sp_Transaction", CusId.ToString());
        ...
        {
            rdCustomer.DataSource = ObjclsFrms.loadList("selcusLikeforOustandingManage", "sp_Masters", CusTxtBOX.Text.ToString());
            rdCustomer.DataTextField = "cus_Name";
            rdCustomer.DataValueField = "cus_ID";
            rdCustomer.DataBind();
        ...
        {
            ViewState["cus"] = rdCustomer.SelectedValue.ToString();
            AssignRoute();
