          ...
          Apply Filter
            ...
            <div class="col-lg-12 row" style="padding-top: 10px;">
                ...
                <ul class="nav nav-pills nav-pills-custom mb-3" style="justify-content:space-around;">
                    ...
                    <li class="nav-item col-lg-4 nav-link btn  btn-sm text-hover-white  btn-active btn-active-purple fs-4 fw-bold px-4 me-1 text-dark   active text-white" data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 31rem; height: 6.5rem; padding-top: 20px; " href="#kt_timeline_widget_1">
                    ...
                    <li class="nav-item col-lg-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-purple fs-4 fw-bold px-4 me-1 " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 31rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_2">
                    ...
                    <li class="nav-item col-lg-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-purple fs-4 fw-bold px-4 me-1 " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 31rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_3">
                  ...
                  <%--  <li class="nav-item col-lg-3 nav-link btn btn-sm btn-color-muted btn-active btn-active-purple fs-4 fw-bold px-4 me-1 " data-kt-timeline-widget-1="tab" data-bs-toggle="tab" style="background-color: white; width: 19.7rem; height: 6.5rem; padding-top: 20px;" href="#kt_timeline_widget_4">
