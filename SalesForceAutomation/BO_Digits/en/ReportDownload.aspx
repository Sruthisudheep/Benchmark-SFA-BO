...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel3">
                ...
                <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
                   ...
                   <%-- <span class="svg-icon svg-icon-white svg-icon-3x ms-n1" style="margin-right: -10px;">
                    ...
                    <div class="text-white fw-bold fs-2 mb-2">Total Sales By Category & Channel</div>
    ...
    <asp:LinkButton ID="getItemwiseSales" runat="server" CssClass="card hoverable card-xl-stretch mb-xl-8" OnClick="getItemwiseSales_Click" BackColor="#CD853F">
        ...
        <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
           ...
           <%-- <span class="svg-icon svg-icon-white svg-icon-3x ms-n1" style="margin-right: -10px;">
            ...
            <div class="text-white fw-bold fs-2 mb-2">Item Wise Sales & Quantity</div> 
            <div class="fw-semibold text-white">Click here to download report</div>
        </div>
        <!--end::Body-->
    </asp:LinkButton>
    ...
    <!--begin::Statistics Widget 5-->
    <asp:LinkButton ID="getorderwisesale" runat="server" CssClass="card hoverable card-xl-stretch mb-xl-8" OnClick="getorderwisesale_Click" BackColor="#CD853F">
        <!--begin::Body-->
        <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
           <%-- <span class="svg-icon svg-icon-white svg-icon-3x ms-n1" style="margin-right: -10px;">
            ...
            <div class="text-white fw-bold fs-2 mb-2">Order Wise Sales & Quantity By Route</div> 
            <div class="fw-semibold text-white">Click here to download report</div>
        </div>
        <!--end::Body-->
    </asp:LinkButton>
    ...
    <!--begin::Statistics Widget 5-->
    <asp:LinkButton ID="getvantovan" runat="server" CssClass="card hoverable card-xl-stretch mb-xl-8" OnClick="getvantovan_Click" BackColor="#da2424">
        <!--begin::Body-->
        <div class="card-body" style="background-image: url('../assets/media/icons/Icon-feather-download.svg'); background-repeat: no-repeat; text-align: right;">
            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
           <%-- <span class="svg-icon svg-icon-white svg-icon-3x ms-n1" style="margin-right: -10px;">
            ...
            <div class="text-white fw-bold fs-2 mb-2">Van to van transfer </div> 
            <div class="fw-semibold text-white">Click here to download report</div>
        </div>
        <!--end::Body-->
    </asp:LinkButton>
