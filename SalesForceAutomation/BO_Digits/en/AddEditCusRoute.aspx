                    ...
                    <div class="kt-portlet__body">
                        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <div class="col-lg-12 row p-4 mb-6" style="border-width:2px; border-style:groove;"> 
                                 <div class="col-lg-4 row fw-bold fs-3"> Route Code :  

                                <div class="col-lg-8 fw-bold fs-3"> <asp:Label runat="server" ID="lblRouteCode" > </asp:Label></div>
                                     </div>

                                 <div class="col-lg-4 row fw-bold fs-3"> Route Name:  

                                <div class="col-lg-8 fw-bold fs-3"> <asp:Label runat="server" ID="lblRouteName" > </asp:Label></div>
                                     </div>
                                                 <div class="col-lg-4 row fw-bold fs-3"> Route Type:  

                                 <div class="col-lg-8 fw-bold fs-3"> <asp:Label runat="server" ID="lblRouteType" > </asp:Label></div>
                                                     </div>
            ...
            <div class="modal-content" style="width:650px;">
                ...
                <div class="modal-footer">
                    ...
                    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel4">
                        ...
                        <asp:LinkButton ID="btnOK" runat="server" OnClick="btnOK_Click" CssClass="btn btn-sm fw-bold btn-secondary" Text="Proceed without Item Mapping" Visible="false"></asp:LinkButton>
