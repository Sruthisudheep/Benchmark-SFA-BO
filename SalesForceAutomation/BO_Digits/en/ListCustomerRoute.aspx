...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="rcs_UsedCreditLimit" AllowFiltering="true" HeaderStyle-Width="100px"
                                            ...
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="rcs_UsedCreditLimit" Display="false">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="rcs_AvailableCreditLimit" AllowFiltering="true" HeaderStyle-Width="100px"
                                            ...
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="rcs_AvailableCreditLimit" Display="false">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="rcs_UsedOrderCredit" AllowFiltering="true" HeaderStyle-Width="100px"
                                            ...
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="rcs_UsedOrderCredit" Display="false">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="rcs_ArPaymodes" AllowFiltering="true" HeaderStyle-Width="100px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="AR Mode" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="rcs_ArPaymodes" Visible="true">
                                        </telerik:GridBoundColumn>
    ...
    HeaderStyle-Font-Size="Smaller" HeaderText="Enforce Buy Back free" FilterControlWidth="100%"
    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
