            ...
            <div class="row">
                <div class=" col-lg-12 row" style="display: -webkit-box; padding-bottom: 10px">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                            <telerik:RadComboBox ID="ddlRotType" Width="100%" runat="server" EmptyMessage="Select Route Type" Filter="Contains" RenderMode="Lightweight" OnSelectedIndexChanged="ddlRotType_SelectedIndexChanged" AutoPostBack="true">
                                <Items>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                            ControlToValidate="ddlRoute" ErrorMessage="Please choose Special Price" ForeColor="Red" Display="Dynamic" ValidationGroup="form"
                                            SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                    </div>
                                </div>
