    ...
    public partial class AddEditRoute : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                string name, username, code, status, pass, unload, deviceid, stlmnt, enforcejp, odometer, rottype, promode, rtntype, lodRej, VantoVan, EnOptCreation,
                    ...
                    InvReconfAppr,varlimit,enablogoutendday;
                ...
                enablogoutendday= lstDatas.Rows[0]["rot_EnableLogoutafterendday"].ToString();
                ...
                ddlenablogout.SelectedValue= enablogoutendday.ToString();
        ...
        protected void Save()
        {
            string name, username, code, user, status, pass, unload, deviceid, enforcejp, stlmnt, odometer, rottype, promode, VantoVan, Lodrej, Rtntype, EnOpt,
                ...
                IsVehicleNo, EnbVehicle, AdvPay, VanApproval,SettleFrom, pettyLimit, InvTrans,fence, CusTrans,MerchTrans,FSTrans , ARManAlloc, ERPInvReqLoc, ERPInvLoc , InvReconfAppr,varlimit, enablogout,
                erpcashbank,erpcashierbank;
            ...
            enablogout= ddlenablogout.SelectedValue.ToString();
            erpcashbank=txtERPCashBank.Text.ToString();
            erpcashierbank=txtERPCashierBank.Text.ToString();
            if (pettyLimit == "")
            {
                pettyLimit = "0"; 
            }
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string[] arr = { code, username, pass, unload, user, deviceid, stlmnt, enforcejp, odometer, status, 
                    ...
                    SettleFrom, InvTrans,pettyLimit,fence,CusTrans,MerchTrans,FSTrans,VanApproval,ARManAlloc, ERPInvReqLoc, ERPInvLoc, InvReconfAppr,varlimit,enablogout,erpcashbank,erpcashierbank};
