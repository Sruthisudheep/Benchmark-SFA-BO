                                                                ...
                                                                <div class="col-lg-12 row" style="border-bottom: 1px solid darkgrey; padding-bottom: 10px;">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        ...
                                                                        <table class="col-lg-12">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <telerik:RadAjaxPanel ID="rapHardCash" runat="server" LoadingPanelID="RadAjaxLoadingPanel13">
                                                                                        ...
                                                                                        <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                            ...
                                                                                            <telerik:RadNumericTextBox ID="txtHardCash" runat="server" CssClass="form-control" Width="80%" AutoPostBack="true" EmptyMessage="0.00" OnTextChanged="txtHardCash_TextChanged" Skin="Silk" Style="text-align: right;">
                                                                                                <NumberFormat AllowRounding="true" DecimalDigits="2" />
                                                                                            </telerik:RadNumericTextBox>

                                                                                        </td>
                                                                                        <td style="padding-bottom: 5px; font-size: 14px; font-weight: 400; text-align: right">
                                                                                            <asp:Label ID="lblHardCashVariance" runat="server" Text="0.00" EmptyMessage="0.00"></asp:Label>
                                                                                        </td>
                                                                                ...
                                                                                <tr>
                                                                                    <telerik:RadAjaxPanel ID="rapPos" runat="server" LoadingPanelID="RadAjaxLoadingPanel14">
                                                                                        ...
                                                                                        <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                            ...
                                                                                            <telerik:RadNumericTextBox ID="txtPos" runat="server" CssClass="form-control" Width="80%" AutoPostBack="true" EmptyMessage="0.00" OnTextChanged="txtPos_TextChanged" Skin="Silk" Style="text-align: right;">
                                                                                                <NumberFormat AllowRounding="true" DecimalDigits="2" />
                                                                                            </telerik:RadNumericTextBox>

                                                                                        </td>
                                                                                        <td style="padding-bottom: 5px; font-size: 14px; font-weight: 400; text-align: right">
                                                                                            <asp:Label ID="lblPOSVariance" runat="server" Text="0.00" EmptyMessage="0.00"></asp:Label>
                                                                                        </td>
                                                                                    </telerik:RadAjaxPanel>
                                                                                ...
                                                                                <tr>
                                                                                    <telerik:RadAjaxPanel ID="rapOnlinePay" runat="server" LoadingPanelID="RadAjaxLoadingPanel15">
                                                                                        ...
                                                                                        <td style="padding-bottom: 5px; font-size: 14px;">
                                                                                            ...
                                                                                            <telerik:RadNumericTextBox ID="txtOnlinePayment" runat="server" CssClass="form-control" Width="80%" AutoPostBack="true" EmptyMessage="0.00" Skin="Silk" OnTextChanged="txtOnlinePayment_TextChanged" Style="text-align: right;">
                                                                                                <NumberFormat AllowRounding="true" DecimalDigits="2" />
                                                                                            </telerik:RadNumericTextBox>

                                                                                        </td>
                                                                                        <td style="padding-bottom: 5px; font-size: 14px; font-weight: 400; text-align: right">
                                                                                            <asp:Label ID="lblOnlinePaymentVariance" runat="server" Text="0.00" EmptyMessage="0.00"></asp:Label>
                                                                                        </td>
                                                                                    </telerik:RadAjaxPanel>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-bottom: 5px; font-size: 14px; font-weight: 400; text-align: right">
                                                                                        <asp:Label ID="lblTotalVariance" runat="server" Text="0.00"></asp:Label>
                                                                                    </td>
                                                                                </tr>
