        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
            ...
            <div class="col-lg-12 row mb-4">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <telerik:RadComboBox ID="rdStatus" runat="server" EmptyMessage="Select Status" Filter="Contains" Width="100%" RenderMode="Lightweight">
                            <Items>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                        ...
                        <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="rah_ReturnType" AllowFiltering="true" HeaderStyle-Width="100px"
                                ...
                                <telerik:GridBoundColumn DataField="ReturnMode" AllowFiltering="true" HeaderStyle-Width="100px"
