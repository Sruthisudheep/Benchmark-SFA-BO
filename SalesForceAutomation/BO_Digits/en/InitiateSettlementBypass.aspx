...
<div class="modal fade modal-center" id="modalConfirm" style="height: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalLabels" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12 row">
                        ...
                        <div class="col-lg-6">
                                <label class="control-label col-lg-12">Please enter the route code again for reconfirmation </label><br />
   ...
   <%-- <div class="modal fade modal-center" id="modalConfirm" style="height: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="ConfirmLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ConfirmLabel">Route Code Confirmation</h5>
            </div>
            <div class="modal-body">
           <%--     <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">--%>
                    <%--<div class="col-lg-12 row">
                        <div class="col-lg-12">
                            <label class="control-label col-lg-12">Please enter the route code again for reconfirmation</label><br />
                            <asp:TextBox ID="txtConfirmRouteCode" runat="server" CssClass="form-control" Width="100%" Placeholder="Route Code"></asp:TextBox>
                        </div>
                        <div class="col-lg-12 mt-2">
                            <asp:Label ID="lblErrorMessage" runat="server" CssClass="text-danger" Text=""></asp:Label>
                        </div>
                    </div>--%>
             <%--   </telerik:RadAjaxPanel>--%>
    ...
    <div class="col-lg-12 text-center mt-5">
        <img alt="Loading..." src="../assets/media/icons/loader.gif" style="border: 0px;" />
            ...
            <%--</div>
            <div class="modal-footer">
                <asp:LinkButton ID="btnConfirmRoute" runat="server" CssClass="btn btn-primary" OnClick="btnConfirmRoute_Click">Confirm</asp:LinkButton>
                <button type="button" class="btn btn-secondary" onclick="$('#modalConfirm').modal('hide');">Cancel</button>
            </div>
        </div>
    </div>
</div>--%>--%>
