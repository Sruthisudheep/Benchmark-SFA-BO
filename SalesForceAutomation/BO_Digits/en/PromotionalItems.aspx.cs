...
namespace SalesForceAutomation.BO_Digits.en
{
    public partial class PromotionalItems : System.Web.UI.Page
    {
        ...
        protected void imgExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                if (!string.IsNullOrEmpty(column.UniqueName) && !string.IsNullOrEmpty(column.HeaderText) && !column.HeaderText.Equals("Invoice")
            ...
            foreach (GridDataItem item in dd.MasterTableView.Items)
            {
                ...
                for (int i = 1; i < grvRpt.MasterTableView.Columns.Count; i++)
                {
                    if (grvRpt.MasterTableView.Columns[i].Display == true)
                    {
                        ...
                        if (!item[grvRpt.MasterTableView.Columns[i].UniqueName].Text.Contains("Invoice"))
                        {
