                                ...
                                <div class="col-lg-12 row">
                                    ...
                                    <asp:PlaceHolder runat="server" ID="SM">
                                        ...
                                        <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox ID="SMCheckBox" CheckBoxes="true" EmptyMessage="Select Region Manager" CausesValidation="false" EnableCheckAllItemsCheckBox="true" Width="100%" runat="server"></telerik:RadComboBox>
                                    ...
                                    <asp:PlaceHolder runat="server" ID="DM">
                                        ...
                                        <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                            <label class="control-label col-lg-12">Region Manager<span class="required"></span></label>
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox ID="ddlSMinDM" runat="server" EmptyMessage="Select Region Manager" Width="100%" CausesValidation="false" OnSelectedIndexChanged="ddlSMinDM_SelectedIndexChanged1" AutoPostBack="true"></telerik:RadComboBox>
                                    ...
                                    <asp:PlaceHolder runat="server" ID="DAM">
                                        ...
                                        <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                            <label class="control-label col-lg-12">Region Manager<span class="required"></span></label>
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox ID="ddlSMinAM" runat="server" EmptyMessage="Select Region Manager" Width="100%" CausesValidation="false" OnSelectedIndexChanged="ddlSMinAM_SelectedIndexChanged1" AutoPostBack="true"></telerik:RadComboBox>
                                    ...
                                    <asp:PlaceHolder runat="server" ID="DSAM">
                                        ...
                                        <div class="col-lg-4 form-group" style="padding-top: 10px;">
                                            <label class="control-label col-lg-12">Region Manager<span class="required"></span></label>
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox ID="ddlSMinSS" runat="server" Width="100%" CausesValidation="false" EmptyMessage="Select Region Manager" OnSelectedIndexChanged="ddlSMinSS_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
