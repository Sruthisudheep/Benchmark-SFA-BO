...
namespace SalesForceAutomation.BO_Digits.en
{
    ...
    public partial class AddEditCustomers : System.Web.UI.Page
    {
        ...
        {
            string code = this.txtCode.Text.ToString().Trim().Replace(" ", ""); ;
        ...
        protected void ddcusType_SelectedIndexChanged(object sender, Telerik.Web.UI.DropDownListEventArgs e)
        {
            ...
            if (ddPT.SelectedValue.Equals("N") && (ddcusType.SelectedValue == "CR"))
            {
                Paymodes.Visible = false;
            }
            else
                ...
                if (!Page.IsPostBack)
                {
                   ...
                   Paymode();
                    ...
                    if (string.IsNullOrEmpty(RotID))
                    {
                        ...
                        //GR And BR need to be Selected

                        foreach (RadComboBoxItem rdGR in rdGRSettings.Items)
                        {
                            rdGR.Checked = true;
                        }
                        foreach (RadComboBoxItem rdBR in rdBRSettings.Items)
                        {
                            rdBR.Checked = true;
                        }
                    ...
                    else                                                                        //If we are editing there will be a value and the following code will be executed.
                    {
                     ...
                     //   RouteLike();
                        ...
                        if (cusType == "CS")
                            ...
                            if ((ddPT.SelectedValue == "N") && (ddcusType.SelectedValue == "CR"))
                            {
                                Paymodes.Visible = false;
                            }
                            else
        ...
        protected void ddlrot_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            Paymode();
            foreach (RadComboBoxItem rdPay in ddlpaymode.Items)
            {
                rdPay.Checked = true;
            }
            ProductMappingGroup();
