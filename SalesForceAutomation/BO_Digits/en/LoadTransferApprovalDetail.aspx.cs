    ...
    public partial class LoadTransferApprovalDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                if ((Status == "AT") || (Status == "R") || (Status == "A"))
                {
                    ...
                    grvRpt.MasterTableView.GetColumn("Status").Display = true;
                    grvRpt.MasterTableView.GetColumn("rsn_Name").Display = true;
                    grvRpt.MasterTableView.GetColumn("DropDownColum").Display = false;
                ...
                else
                {
                    ...
                    grvRpt.MasterTableView.GetColumn("Status").Display = false;
                    grvRpt.MasterTableView.GetColumn("rsn_Name").Display = false;
                    grvRpt.MasterTableView.GetColumn("DropDownColum").Display = true;
                }
        ...
        protected void grvRpt_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                reasonDrop.DataSource = ObjclsFrms.loadList("SelectReasonforLoadTranferReq", "sp_LoadTransferRequest");
                ...
                try
                {
                    ...
                    else if ((item["Status"].Text.Equals("R")))
                    {
        ...
        protected void lnkApprove_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (GridDataItem item in grvRpt.MasterTableView.Items)
                {
                    ...
                    else if (selectedValue.Equals("R") && reason.Equals("") && AllApprove.Checked == false)
                    {
        ...
        private void createNode(string ldr_ID,string Reason,  string Status, XmlWriter writer)
        {
