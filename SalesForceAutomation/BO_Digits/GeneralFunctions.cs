       ...
       General ObjGeneral = new General();
        ...
        public DataTable loadList(string sp)
        {
            ...
            catch (SqlException ex)
            {
                ...
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 1", sp +  "Error : " + ex.Message.ToString() + " - " + innerMessage);
                return null;
                //
            }
            catch (Exception ex)
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions12 ", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                return null;
                //
            }
            finally
        ...
        public DataTable loadList(string Mode, string sp)
        {
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 2", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Source: " & MyExp.Source & ControlChars.Cr & ControlChars.Cr & "State: " & MyExp.State.ToString() & ControlChars.Cr & "Class: " & MyExp.Class.ToString() & ControlChars.Cr & "Server: " & MyExp.Server & ControlChars.Cr & "Message: " & MyExp.Message.ToString() & ControlChars.Cr & "Line: " & MyExp.LineNumber.ToString())
                return null;
                //
            }
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions22 ", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Message : " & Exp.Message)
                return null;
                //
            }
        ...
        public DataTable loadList(string Mode, string sp, string Para1, string[] Paras)
        {
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 3", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Source: " & MyExp.Source & ControlChars.Cr & ControlChars.Cr & "State: " & MyExp.State.ToString() & ControlChars.Cr & "Class: " & MyExp.Class.ToString() & ControlChars.Cr & "Server: " & MyExp.Server & ControlChars.Cr & "Message: " & MyExp.Message.ToString() & ControlChars.Cr & "Line: " & MyExp.LineNumber.ToString())
                return null;
                //
            }
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 33", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Message : " & Exp.Message)
                return null;
                //
            }
        ...
        public DataTable loadList(string Mode, string sp, string Where)
        {
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 4", sp+":"+Mode + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Source: " & MyExp.Source & ControlChars.Cr & ControlChars.Cr & "State: " & MyExp.State.ToString() & ControlChars.Cr & "Class: " & MyExp.Class.ToString() & ControlChars.Cr & "Server: " & MyExp.Server & ControlChars.Cr & "Message: " & MyExp.Message.ToString() & ControlChars.Cr & "Line: " & MyExp.LineNumber.ToString())
                return null;
                //
            }
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions44 ", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Message : " & Exp.Message)
                return null;
                //
            }
        ...
        public DataTable loadListX(string Mode, string sp, string Where)
        {
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions5 ", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Source: " & MyExp.Source & ControlChars.Cr & ControlChars.Cr & "State: " & MyExp.State.ToString() & ControlChars.Cr & "Class: " & MyExp.Class.ToString() & ControlChars.Cr & "Server: " & MyExp.Server & ControlChars.Cr & "Message: " & MyExp.Message.ToString() & ControlChars.Cr & "Line: " & MyExp.LineNumber.ToString())
                return null;
                //
            }
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 55", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Message : " & Exp.Message)
                return null;
                //
            }
        ...
        public DataSet loadList(string Mode, string sp, string Para1, string[] Paras, Boolean isDataSet)
        {
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 6", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Source: " & MyExp.Source & ControlChars.Cr & ControlChars.Cr & "State: " & MyExp.State.ToString() & ControlChars.Cr & "Class: " & MyExp.Class.ToString() & ControlChars.Cr & "Server: " & MyExp.Server & ControlChars.Cr & "Message: " & MyExp.Message.ToString() & ControlChars.Cr & "Line: " & MyExp.LineNumber.ToString())
                return null;
                //
            }
            ...
            {
                 String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 66", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                //MessageBox.Show("Message : " & Exp.Message)
                return null;
                //
            }
        ...
        public string Bulk_ExcelUpdate(DataTable dt, string sp, string UserID)
        {
            ...
            {
                String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 7", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
            ...
            {
                String innerMessage = (ex.InnerException != null) ? ex.InnerException.Message : "";
                LogMessageToFile(UICommon.GetLogFileName(), "General Functions 77 ", sp + "Error : " + ex.Message.ToString() + " - " + innerMessage);
                return ex.Message.ToString() + " - " + innerMessage;
                //
            }
            finally
